...
if uploaded_file :
    ...
    embeddings = OpenAIEmbeddings(openai_api_key=user_api_key, model_name="gpt-3.5-turbo")
    ...
    Please be as specific as possible, also you are a friendly medical chatbot who is always polite.
    {context}
    Question: {question}"""
    ...
    if 'generated' not in st.session_state:
        st.session_state['generated'] = ["Hello ! Ask me anything about what is bothering you 🤗"]
